...
const Navbar = () => {
  ...
  return (
    <nav className='flex justify-between items-center bg-gray-900 text-white px-4 md:h-20 flex-col md:flex-row'>
      <div>
        <Link href={"/"} className="logo font-bold flex items-center">
          <img className='invertImg' width={55} src="/tea.gif" alt="" />
      ...
      <div className='relative'>
        {session && <>
          ...
          <div id="dropdown" className={`z-10 mt-3 ${showDropDown ? "" : "hidden"} absolute left-[125px] bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700`}>
